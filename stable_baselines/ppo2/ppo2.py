...
class PPO2(ActorCriticRLModel):
    ...
    """
    def __init__(self, policy, env, gamma=0.99, n_steps=128, ent_coef=0.01, learning_rate=2.5e-4, d_stepsize = 3e-4, vf_coef=0.5,
        ...
        self.using_gail = False ## this will be set true in GAIL_PPO2.__init__
        ...
        self.approxkl = None
        self.clipfrac = None
        self._d_train = None ## apply gradient on discriminator
        self._g_train = None ## apply gradient on generator 
        ...
        if self.using_gail and self.expert_dataset is not None:
            for _ in range(10):
                ...
                self._train_d_step(obs,actions,ob_expert,ac_expert,update=self.num_timesteps,writer=None)
