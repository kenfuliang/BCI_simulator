...
class DummyVecEnv(VecEnv):
    ...
    def _get_target_envs(self, indices):
        ...
        if isinstance(self.envs[0],Monitor) or isinstance(self.envs[0],gym.wrappers.Monitor):
            return [self.envs[i].env for i in indices]
        elif isinstance(self.envs[0].env,gym.Env):
